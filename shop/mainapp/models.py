...
class Smartphone(Product):
    ...
    accum_value = models.CharField(max_length=255, verbose_name='Емкость батареи')
    ram = models.CharField(max_length=255, verbose_name='Оперативная память')
    sd = models.BooleanField(default=True, verbose_name='Наличие sd карты')
    sd_volume_max = models.CharField(
        max_length=255, null=True, blank=True, verbose_name='Максимальный объем SD карты'
    )
    store_max = models.CharField(max_length=255, verbose_name='Обьем встроенной памяти')
